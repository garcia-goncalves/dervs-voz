#!/usr/bin/env python3
"""DERVS XTTS — daemon da voz humana.
...
Protocolo de linha, igual ao dos ouvidos (dervs_stt_daemon):
...
FALANTE = os.environ.get("DERVS_XTTS_SPEAKER", "Damien Black")
IDIOMA = os.environ.get("DERVS_XTTS_LANG", "pt")
...
def main() -> None:
    ...
    while True:
        ...
        try:
            ...
            saida = tempfile.NamedTemporaryFile(prefix="dervs_xtts_",
            ...
            sys.stderr.write("dervs_xtts: erro (%s)\n" % erro)
            sys.stderr.flush()
